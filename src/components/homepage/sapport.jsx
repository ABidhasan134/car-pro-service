...
const Sapport = () => {
  return (
    <section className='mt-10 relative flex justify-evenly rounded-2xl p-6 mb-20 bg-[#CBD5E1]'>
        ...
        <Image src={calender} alt='calender' height={200} width={100}></Image>      
        ...
        {/* phone */}
        <div className='flex items-center'>
        <Image src={phone} alt='phone' height={200} width={120} className='relative left-4'></Image>      
        <div className='grid items-center'>
            <p>Have a question?</p>
        ...
        {/* location */}
        <div className='flex items-center'>
        <Image src={location} alt='location' height={200} width={100}></Image>      
        <div className='grid items-center'>
